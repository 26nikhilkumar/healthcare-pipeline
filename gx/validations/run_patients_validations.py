...
# Load your data
df = pd.read_csv('../../data/01_raw/patients.csv')

# Define the batch request
batch_request = RuntimeBatchRequest(
    datasource_name="my_datasource",
    data_connector_name="default_runtime_data_connector_name",
    data_asset_name="patients",  # this can be any identifier for the dataset
...
checkpoint_config = {
    ...
    "run_name_template": "%Y-%m-%d-%H-%M-%S-patients-checkpoint",
...
try:
    context.delete_checkpoint("patients_checkpoint")
...
results = context.run_checkpoint(
    checkpoint_name="patients_checkpoint",
